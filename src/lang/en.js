export default {
  ...
  // 'deposit': 'Deposit',
  // 'withdraw': 'Withdrawal',
  // 'wallet_accosaada': 'About the fund account',
  // 'copy': 'Copy',
  ...
  // 'invite_notice_title': 'Invite friends to sign up and the invitee can get <span style="color: #FFD426;font-weight: bold;">10%</span> of the trading fee for <span style="color: #FFD426;font-weight: bold;">90 consecutive days</span>', 'activity_time': 'Activity time: ',
  // 'activity_explaination_ix': 'The final interpretation of this contest activity rests with IXX.COM.', 'header_title_hot_activity': 'Popular Activities',
  ...
  // 'user': 'User',
  // 'join_match': 'Joined',
  // 'activity_bet_success': 'Bidding Successful', 'activity_result_0': 'Unopened',
  // 'activity_result_1': 'Winning Rise',
  // 'activity_result_2': 'Winning Flat',
  // 'activity_result_3': 'Winning Fall', 'lever_transfer_in': ' deposit fund ',
  ...
  // 'dowload_text_1': 'First in the world',
  // 'dowload_text_2': 'One-stop Listing Digital Asset Service Center',
  ...
  // 'download_ios_click_right': 'Click on the top right corner to open in safari',
  ...
  // 'about_eos_address_label_a': 'Topping up EOS requires a top up address and an EOS address tag (or tag/memo, etc.). Address tag is a numeric string that guarantees the uniqueness of your coin address and appears in pairs with the coin address.',
  // 'about_eos_address_label_b': 'Please remember to follow the correct steps when topping up EOS. Enter the complete information when doing withdrawal to avoid the risk of losing coins!',
  ...
  // 'activity_lock_fenhong': 'Lock warehouse dividend',
  // 'activity_invite_reward': 'Invite rewards',
  ...
  // 'activity_lock_share': 'Rule of Lock warehouse dividend:',
  ...
  // 'warehouse_margin': 'contract position deposit',
  // 'entrust_margin': 'entrusted guarantee deposit',
  // 'margin_balance': 'guarantee balance',
  // 'account_exchange': 'Transfer of funds',
  // 'account_transfer_come_on': 'Transfer',
  // 'wallet_balance': 'wallet balance',
  // 'unrealized_profit_and_loss': 'Yet to be realized profit and loss',
  ...
  // 'contract_has_equal_pos': 'Closed position',
  // 'contract_history_pos_history': 'history of positions',
  // 'contract_history_del_current': 'Current order',
  ...
  // 'contract_history_stop_loss': 'Stop loss commission',
  // 'contract_history_deal_fills': 'Excuted',
  ...
  // 'contract_history_postion_header_avg': 'Opening position price',
  ...
  // 'contract_history_postion_header_force': 'Forced liquidation price',
  // 'contract_history_postion_header_force_tips': '<a>Forced liquidation price</a><br/>if the price of the position is lower than the existing price (multiple positions) or higher than the existing price (empty position), you will be forced to close the position。',
  ...
  // 'contract_history_postion_header_delta_rate': 'Unrealised PNL(ROE %)',
  ...
  // 'contract_force_equal_price': 'Forced liquidation price',
  ...
  // 'contract_action_open_short': 'Close',
  ...
  // 'contract_action_delegate_type': 'Delegation types',
  ...
  // 'contract_click_to_wallet': 'Available balanceyou create the available balance of the commission. Click here to view the wallet details.',
  ...
  // 'contract_result_yet': 'Realized profit and loss',
  ...
  // 'contract_account_rights': 'account rights',
  // 'contract_account_rights_tips': 'Account equity = (deposit - withdrawal + realized profit and loss)',
  // 'contract_margin_balance': 'margin balance',
  // 'contract_margin_balance_tips': 'Deposit balance = the amount of deposit that the user can use to open a position = account equity - position deposit- commissioned deposit。',
  ...
  // 'contract_equal_werehouse_price': 'Liquidation price',
  ...
  // 'contract_current_werehouse_poi': 'Size',
  // 'contract_current_werehouse_poi_tips': '<a>Size</a><br/>your position in this contract, positive number is multiple positions; negative number is short position。',
  // 'contract_mark_price': 'Tagged price',
  // 'contract_mark_price_tips': '<a>tagged price</a><br/>This is the current marked price, click for more information。',
  // 'contract_mark_price_tips_table': "<a>Tagged  Price</a><br/> Margin - Margin used by the open and locked positions. If you have enabled a position, this value will decrease as the margin falls, which also means your actual leverage rises. Move the 'slider' to adjust the margin assigned to each position。",
  ...
  // 'contract_many_piece_con': '%{amount}":"%{amount}contract',
  // 'contract_have_apply_yet': 'Currently allocated deposits:',
  // 'contract_max_remove_account': 'maximum surplus that cashed out:',
  // 'contract_24_hour_trade': '24hour trading volume',
  // 'contract_24_hour_trade_tips': '<a>24-hour turnover</a><br/> The total contract value of the first 24 hours。',
  ...
  // 'contract_risk_modal_tips': ' IX employs a sliding incremental risk limit. For BTC perpetual contracts, the underlying risk limit is 200 BTC. For each 100 BTC position limit increase, the maintenance margin and initial margin will increase by 0.50%。',
  ...
  // 'contract_pos_after_deal': 'Post transacted position',
  // 'contract_expect_equal_price': 'Future price of liquidation',
  // 'contract_diff_expect_force': 'Targeted price/forecast of liquidation price price difference',
  // 'contract_lever_times': ' Multiple leverage',
  // 'contract_FUTURE_BTCUSD': ' BTC Perpetual',
  // 'contract_FUTURE_BHDUSD': 'BHD Perpetual',
  // 'contract_complete_deal': 'Completed transactions',
  ...
  // 'contract_never_show': 'never show again',
  ...
  // 'contract_how_price_tip_d': ' Today at %{next_pay_time}, longs will pay %{feerate}%, and shorts will receive%{feerate}%. IXX.COM will not charge fees on funding payments。',
  ...
  // 'contract_index_price': ' Price Index',
  ...
  // 'contract_assigning_undeal': 'Incomplete transactions in commissioned trading',
  // 'contract_assigning_deal_part': 'Partial transactions in commissioned trading',
  ...
  // 'ensurance_btc_future_rule': '%{coin} Perpetual Contracts Rule',
  ...
  // 'contract_trigger_price_rule': 'trigger price',
  ...
  // 'stop_win_loss_warn_content': 'After the stop loss order is executed, your position will be increased from %{hold} to %{will hold}. Then you have selected the "Shutdown after trigger" option. The purpose of this option is to Closing the position. If you continue, the stop loss order may be cancelled immediately after being triggered.',
  ...
  // 'guide_title_index0_step4': "What Does 'No. of Swaps' Means?",
  ...
  // 'contract_trigger_win_buy': 'take profit  buying',
  // 'contract_trigger_win_sell': 'take profit  selling',
  // 'contract_trigger_lose_buy': 'Buy Stop',
  // 'contract_trigger_lose_sell': 'Sell stop',
  // 'contract_trigger': 'trigger',
  // 'contract_trigger_tips_buy': 'Trigger: Last Price @%{price} and below',
  // 'contract_trigger_tips_sell': 'Trigger: Last Price @%{price} and above',
  // 'contract_passive_cancel': 'As the post-only order mode on, this direction can not ordered by Price ',
  // 'contract_trigger_type': 'Trigger type',
  // 'contract_trigger_close': 'trigger liquidation',
  ...
  // 'contract_action_position': 'Position',
  // 'contract_action_limit_price': 'Limits',
  // 'contract_action_market_price': 'Market',

  // 'contract_order_enter_tips1': 'Please enter the amount',
  // 'contract_order_enter_tips2': 'Please enter the price ',
  ...
  // 'homechart_24h_change_range': 'Change rate',
  // 'homechart_24h_change_value': 'Change amt',
  ...
  // 'transfer_able_amount': 'Transferable amount：',
  // 'transfer_btc_history': 'transaction history',
  // 'transfer_currency': ' transfer currency',
  // 'transfer_from_a': ' transfer from',
  // 'transfer_to_a': 'transfer to',
  ...
  // 'otc_total_transaction_volume': 'Current Site Transaction Total (%{currency})',
  // 'otc_total_arder': 'Total singular',
  ...
  // 'contract_cancel_all': 'Cancelled All',
  ...
  // 'otc_otutcol_15': 'Contract asset valuation',
  ...
  // 'otc_otutcol_11': 'IX Total net asset valuation',
  ...
  // 'otc_otutcol_14': 'Valuation of trading assets',
  // 'otc_otutcol_16': 'After successful deposition, if want to conduct  any coin, fiat or contract trading, you  need to transfer funds from  Fund account to the corresponding account',
  ...
  // 'contract_FUTURE_ETHUSD': 'ETH Perpetual',
  // 'trading_order_cancel_all': 'Cancelled all',
  ...
  // 'FUTURE_&USD': '%{currency} Perpetual',
  // 'canceled': 'Canceled',
  // 'CNY': 'CNY',
  // 'SGD': 'SGD',
  ...
  // 'link_name': 'link name',
  // 'otc_need_authentication': "%{side} requires <span style='color:$primary;'>Advanced verification</span>",
